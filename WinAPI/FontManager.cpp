...
void FontManager::drawText(HDC hdc, int destX, int destY, char* fontName, int fontSize, int fontWeight, string printString, int length, COLORREF color)
{
	SetBkMode(hdc, TRANSPARENT);
	SetTextColor(hdc, color);
	...
	LPCSTR str = printString.c_str();

	oldFont = (HFONT)SelectObject(hdc, font);
	TextOut(hdc, destX, destY, str, length);
